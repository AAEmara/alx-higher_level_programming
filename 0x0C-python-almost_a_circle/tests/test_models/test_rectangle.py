...
class TestRectangleClass(unittest.TestCase):
    ...
    def test_update_args(self):
        """Checks that the attrs. are updated by the update function in case
        args exists or not."""
        ...
        self.case_5.update(height=89)
        self.assertEqual(self.case_5.height, 89)
